"""
web_words_modified_femi.py - Project script (example).
...
Run from root project folder with:
  ...
  uv run python -m nlp.web_words_modified_femi
"""
...
# ============================================================
# Section 9. Build Bigram Frequencies (two-word phrases)
# ============================================================

# Create bigrams from adjacent cleaned words.
# Example: ["natural", "language", "processing"] becomes
# [("natural", "language"), ("language", "processing")]
bigrams: list[tuple[str, str]] = list(zip(clean_words, clean_words[1:], strict=False))

# Count the frequency of each bigram.
bigram_counts = Counter(bigrams)

# Convert the 10 most common bigrams into a Polars DataFrame.
top_bigrams = bigram_counts.most_common(10)

bigram_df: pl.DataFrame = pl.DataFrame(
    {
        "bigram": [f"{w1} {w2}" for (w1, w2), _ in top_bigrams],
...
# ============================================================
# Section 10. Build "Most Frequent Bigrams" Bar Chart
# ============================================================
...
plt.title("Top 10 Most Frequent Two-Word Phrases")
plt.xlabel("Bigram")
plt.ylabel("Frequency")
plt.tight_layout()
plt.show()
